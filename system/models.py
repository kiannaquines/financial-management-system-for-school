...
class Assistance(models.Model):
    ...
    request_by = models.ForeignKey('Membership', on_delete=models.CASCADE, help_text="The name of the member who requested the assistance")
    id = models.AutoField(primary_key=True)
    assistance_first_name = models.CharField(max_length=50, help_text="The first name of the employee")
    assistance_middle_name = models.CharField(max_length=50, blank=True, null=True, help_text="The middle name of the employee")
    assistance_last_name = models.CharField(max_length=100, help_text="The last name of the employee")
    suffix = models.CharField(max_length=10, blank=True, null=True, help_text="The suffix of the employee")
...
class Beneficiary(models.Model):
    ...
    user_id = models.ForeignKey('Membership', related_name="beneficiary_membership", on_delete=models.CASCADE, help_text="Select related user to the beneficiary")
    id = models.AutoField(primary_key=True)
    beneficiary_first_name = models.CharField(max_length=50, help_text="First name of the beneficiary")
    beneficiary_middle_name = models.CharField(max_length=50, blank=True, help_text="Middle name of the beneficiary, optional.")
    beneficiary_last_name = models.CharField(max_length=50, help_text="Last name of the beneficiary")
    suffix = models.CharField(max_length=10, blank=True, null=True, help_text="Suffix of the beneficiary, optional")
    relationship = models.CharField(max_length=50, choices=RELATIONSHIP, help_text="Relationship to the beneficiary")
    date_of_birth = models.DateField(help_text="Date of Birth of the beneficiary")
    proof = models.ImageField(upload_to="beneficiary/proof/", help_text="Upload birth certificate of the beneficiary")
...
class Membership(models.Model):
    ...
    contact_number = models.CharField(max_length=20, help_text="Contact number of the employee")
    employee_id = models.CharField(max_length=50, help_text="Employee ID of the employee")
...
class Payment(models.Model):
    ...
    id = models.AutoField(primary_key=True)
    paid_by = models.ForeignKey(Membership, related_name="payment_name", on_delete=models.CASCADE, limit_choices_to={'user_id__user_type': 'Employee'}, help_text="Employee who paid")
    amount = models.FloatField(help_text="Amount employee paid")
    payment_type = models.CharField(max_length=50, choices=PAYMENT_TYPE, help_text="Payment type made by the employee")
